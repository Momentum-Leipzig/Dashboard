...
output:
  html_document:
    ...
    toc_depth: 1
    include:
      after_body: _footer_Richard.txt
...
#cache.whatever inside the chunk options tells the chunk, that it has to be invalidated, as soon as one of these variables change. Otherwise, changing the plots in the chunk above doesn't invalidate this chunk and the lastly cached version will be displayes.
...
## Overall Development over Time {.tabset .tabset-fold}   
