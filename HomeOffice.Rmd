...
```{r include=TRUE, fig.show='hold', out.width = c('50%','50%'), fig.cap= "Percentage of time worked from home in December 2019"}
...
HO_Perc_rel$missing = c(NA, HO_Perc_rel[2,2],mean(c(HO_Perc_rel[2,2],HO_Perc_rel[4,2])),HO_Perc_rel[4,2],NA,NA,NA,NA) #Extrapolating the missing value in June to make a separate connecting line in the graph
HO_Perc_rel$mis_sd = c(NA, HO_Perc_rel[2,3],mean(c(HO_Perc_rel[2,3],HO_Perc_rel[4,3])),HO_Perc_rel[4,3],NA,NA,NA,NA)
...
```{r Percentage over Time 2, include = TRUE, out.width='100%', fig.height=3.5}
## For details on the code for the plots, please change to the "Plots"-Tab and unfold the code there. ##
...
```{r distributions over Time 2, fig.show= 'hold', out.width=c('50%','50%')}
## For details on the code for the plots, please change to the "Plots"-Tab and unfold the code there. ##
...
```{r Possibility to work from home 2, include=T, fig.show='hold', out.width = c('50%','50%'), fig.cap="Allowed to work from home"}
## For details on the code for the plots, please change to the "Plots"-Tab and unfold the code there. ##
...
HO_Perm_rel = data.frame(
  perm = round(c((length(which(HO_Perm$T3_HO4 == 2))/length(which((HO_Perm$T3_HO4 != "NA")))),
           ...
           (length(which(HO_Perm$T9_HO4 == 2))/length(which((HO_Perm$T10_HO4 != "NA"))))
    
            )*100, digits = 2),
  
  month = as.factor(months_compl)
)
HO_Perm_rel$missing = c(NA,HO_Perm_rel[2,1],mean(c(HO_Perm_rel[2,1],HO_Perm_rel[4,1])),HO_Perm_rel[4,1],NA,NA,NA,NA)
...
```{r Permission over Time 2, include = TRUE, out.width = '100%', fig.height= 3}
## For details on the code for the plots, please change to the "Plots"-Tab and unfold the code there. ##
...
HO_loc_prop_long$location = rep(c("Own Room","Designated Spot","Changing","Other"), 7)
...
```{r Location of work 2, include=TRUE, out.width='100%', fig.height= 3}
## For details on the code for the plots, please change to the "Plots"-Tab and unfold the code there. ##
...
HO_Isol$T10mean = rowMeans(HO_Isol[,c("T10_HO13","T10_HO14","T10_HO15","T10_HO16")])
...
```{r Isolation 2, include = TRUE, out.width='100%', fig.height=3.5}
## For details on the code for the plots, please change to the "Plots"-Tab and unfold the code there. ##
...
```{r Satisfaction 2, include=TRUE, out.width='100%', fig.height=3.5}
## For details on the code for the plots, please change to the "Plots"-Tab and unfold the code there. ##
...
```{r Satisfaction parenting 2, include= TRUE, out.width='100%', fig.height=3.5}
## For details on the code for the plots, please change to the "Plots"-Tab and unfold the code there. ##
...
HO_Sat_Eff =   reshape(HO_Sat[,!(names(HO_Sat) %in% c("T4_HO3","T6_HO3", grep( "_covid11",names(HO_Sat), value = T)))], varying = list(c("T3_HO31","T4_HO31","T6_HO31","T7_HO31","T8_HO31", "T9_HO31", "T10_HO31"), c("T3_HO32","T4_HO32","T6_HO32","T7_HO32","T8_HO32", "T9_HO32", "T10_HO32")), direction = "long", timevar = "month", idvar = "ID", v.names = c("Sat", "Eff"))
...
HO_Sat_Eff$month = factor(HO_Sat_Eff$month, levels = 1:7, labels = months_miss)
...
```{r efficacy 2, include= TRUE, fig.height=3.5, out.width='100%' }
## For details on the code for the plots, please change to the "Plots"-Tab and unfold the code there. ##
...
### Additional Information {-}  
```{r equipment 2, include=T, out.extra='style="float:left; padding:10px"', fig.height=5, fig.width=3}
